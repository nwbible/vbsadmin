        ...
        public static byte[] ExportAttendanceExcel(List<Classroom> classrooms)
        {
            ...
            using (ExcelPackage package = new ExcelPackage())
            {
                foreach (Classroom classroom in classrooms)
                {
                    ...
                    worksheet.Cells["B1"].Value = "Child Pick-Up Code";
                    worksheet.Cells["C1"].Value = "Monday";
                    worksheet.Cells["D1"].Value = "Tuesday";
                    worksheet.Cells["E1"].Value = "Wednesday";
                    worksheet.Cells["F1"].Value = "Thursday";
                    worksheet.Cells["G1"].Value = "Friday";
                    ...
                    foreach (Child child in sortedChildren)
                    {
                        ...
                        worksheet.Cells["B" + rowCount].Value = child.Password;
                        rowCount++;
                    }
